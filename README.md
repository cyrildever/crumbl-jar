...
_IMPORTANT: for security purpose, you must download the latest BouncyCastle JAR (eg. `bcprov-jdk15to18-1.76.jar`) and refer to it in the classpath of your command-line along with the Crumbl&trade; JAR._
